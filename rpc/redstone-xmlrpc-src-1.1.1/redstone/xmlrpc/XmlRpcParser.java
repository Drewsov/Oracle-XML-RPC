    ...
    public void parse( InputStream is ) throws XmlRpcException
    {
        ...
        synchronized ( readers )
        {
            if ( readers.empty() )
            {
                ...
                {    System.out.println("XmlRpcParser.ReaderInstantiationError:"   + e); 
        ...
        try
        {
            try
            {
                ...
                catch ( Exception e1 ){System.out.println("XmlRpcParser.ParsingError(2)" + e+":"+e1+"\n=>"+is+"<=\n");
                }
            }
            catch ( Exception e )
            {   System.out.println("XmlRpcParser.ParsingError:" + e);
                throw new XmlRpcException(
